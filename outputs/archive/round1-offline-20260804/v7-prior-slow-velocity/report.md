...
**Assessment:** Training completed with the following flags: Overfitting detected (avg val/train ratio 9.481x over last 10% of epochs) — reduce capacity, add regularization, or increase simulation budget. Treat the downstream diagnostics as provisional until these are addressed.
...
| Metric | w | r | v | noise |
|--------|-----|-----|-----|-----|
| NRMSE | 0.526 | 0.078 | 0.485 | 0.599 |
| Log-gamma | -inf | -inf | -inf | -inf |
| ECE | 0.397 | 0.213 | 0.402 | 0.413 |
| Post. Contraction | 0.960 | 0.998 | 0.965 | 0.950 |
...
1. Overfitting detected (val/train loss ratio 9.481x in final 10% of epochs) — reduce network capacity, add regularization, or increase simulation budget.
