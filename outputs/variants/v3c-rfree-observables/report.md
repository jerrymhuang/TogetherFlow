...
**Assessment:** w, v, noise show contraction in the acceptable range; r fall short.

## Numerical Diagnostic Summary

| Metric | w | r | v | noise |
|--------|-----|-----|-----|-----|
| NRMSE | 0.269 | 0.844 | 0.243 | 0.354 |
| Log-gamma | 3.743 | 4.783 | 2.604 | 0.064 |
| ECE | 0.015 | 0.010 | 0.019 | 0.016 |
| Post. Contraction | 0.933 | 0.293 | 0.947 | 0.873 |

**w** — excellent calibration; poor recovery; medium contraction

**r** — excellent calibration; poor recovery; low contraction
...
1. Poor recovery for w, r, v, noise — increase network capacity and training duration; if no improvement, these parameters may be weakly identifiable.
2. Low contraction for r — the data may not be informative for these parameters; consider a more informative prior or a richer summary network.
