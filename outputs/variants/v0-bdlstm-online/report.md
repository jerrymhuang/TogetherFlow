# Reference model with the published BiLSTM summary network

**Variant:** `v0-bdlstm-online`  
**Addresses:** Summary-network justification

## Why this arm exists

The published summary network is a bidirectional LSTM behind two strided convolutions; nothing in the paper justifies that choice against an alternative. Paired with v0-reference, which differs only in the sequence model — same prior, observables, seed and online budget — so the gap is attributable to architecture alone.
...
| Metric | w | r | v | noise |
|--------|-----|-----|-----|-----|
| NRMSE | 0.290 | 0.077 | 0.211 | 0.510 |
| Log-gamma | 0.179 | -11.394 | 1.146 | 1.305 |
| ECE | 0.026 | 0.069 | 0.046 | 0.006 |
| Post. Contraction | 0.916 | 0.994 | 0.954 | 0.732 |
