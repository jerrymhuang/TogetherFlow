...
namespace DroneController
{
    namespace Profiles
    {
        ...
        {
            public EControlComplexity controlComplexity;
    ...
    namespace Physics
    {
        ...
        public class DroneMovementScript : MonoBehaviour
        {
            ...
            [HideInInspector] public JoystickDrivingAxis left_analog_y_movement = JoystickDrivingAxis.upward;
            [HideInInspector] public JoystickDrivingAxis left_analog_x_movement = JoystickDrivingAxis.rotation;
            [HideInInspector] public JoystickDrivingAxis right_analog_y_movement = JoystickDrivingAxis.forward;
            [HideInInspector] public JoystickDrivingAxis right_analog_x_movement = JoystickDrivingAxis.sideward;
            ...
            */
            ...
            /// </summary>
            void Joystick_Input_Sensitivity_Calculation() //getting the input from joystick and determining where to move
            {
                //only I and K
            ...
            public Profile CurrentProfile { get { return profiles[_profileIndex]; } }
            ...
            /// Handles tilt values and applies it, guess where? here! :)
            /// </summary>
            public void BasicDroneHoverAndRotation()
            {
                ...
                /*
                switch (CurrentProfile.controlComplexity)
                {
                    case EControlComplexity.Simple:
                        Vector2 velocity = ourDrone.velocity.FlattenZ();
                        if (velocity.magnitude > 0)
                        {
                            float newYaw = Mathf.Rad2Deg * HelperFunctions.AngleBetween(Vector2.up, ourDrone.velocity.normalized.FlattenZ());
                            ourDrone.rotation = Quaternion.Euler(new Vector3(0, newYaw, 0));
                        }
            ...
            /// <summary>
            /// Determining whether we are using joystick, mobile or a keyboard
            ...
            /// <summary>
            /// Movement forwards and backwards and tilting
            /// </summary>
