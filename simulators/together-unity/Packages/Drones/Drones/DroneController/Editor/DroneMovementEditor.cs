...
public class DroneMovementEditor : Editor {
    ...
    void DrawCustomProfilesWindow(DroneMovementScript myScript)
    {
        ...
        {
            default:
                EditorGUILayout.LabelField("Control Complexity", EditorStyles.toolbarButton);
                myScript.profiles[myScript._profileIndex].controlComplexity = (EControlComplexity)EditorGUILayout.EnumPopup(new GUIContent("Control Complexity", "Simple restricts certain controls."), myScript.profiles[myScript._profileIndex].controlComplexity);
